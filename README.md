...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geovista-feedstock/blob/master/LICENSE.txt)

Summary: Cartographic rendering and mesh analytics with PyVista
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12697&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geovista-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geovista` can be installed with:

```
conda install geovista
```

It is possible to list all of the versions of `geovista` available on your platform with:
